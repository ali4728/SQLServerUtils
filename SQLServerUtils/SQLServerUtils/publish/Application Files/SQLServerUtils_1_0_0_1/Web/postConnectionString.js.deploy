...
function logThis(aaa) {
    //console.log(aaa.substring(0, 120));
}
...
MsSqlDependencyBrowser.controller('ConnectFormCtrl', function ($scope, $rootScope, $http, DatabaseService) {
    ...
    $scope.model = {
        ...
        databaseList: [],
        serverList: ['DESKTOP10\\SQL14','(LocalDb)\\MSSQLLocalDB'],
        inProgress: false,
        errorMessage: ''
    };
    ...
    $scope.upDbList = function () {
        console.log('######## BLURRRRRRRRRRR ##########');
        console.log(getServerVal());
